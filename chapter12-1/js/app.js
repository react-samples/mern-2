...
var Message = function (_React$Component) {
  ...
  _createClass(Message, [{
    ...
    value: function alertMessage(message) {
      ...
      setTimeout(function () {
        _this2.setState({ showAlert: false });
      }, 5000);
    }
  }, {
    ...
    value: function componentWillMount() {
      ...
      (0, _isomorphicFetch2.default)("http://localhost:3000/messages").then(function (res) {
        if (res.status >= 400) {
          _this3.alertMessage(res.status);
        } else {
          return res.json();
        }
      }).then(function (json) {
        _this3.setState({ msgs: json.messages });
      });
    }
  }, {
    ...
    value: function componentDidMount() {
      ...
      (0, _isomorphicFetch2.default)("http://localhost:3000/user").then(function (res) {
        if (res.status >= 400) {
          _this4.alertMessage(res.status);
        } else {
          return res.json();
        }
      }).then(function (json) {
        _this4.setState({ user: json.user });
      });
      (0, _isomorphicFetch2.default)("http://localhost:3000/update").then(function (res) {
        if (res.status >= 400) {
          _this4.alertMessage(res.status);
        } else {
          return res.json();
        ...
        _this4.setState({ csrf: json.csrf });
      });
    }
  }, {
    key: 'sendMessage',
    value: function sendMessage() {
      ...
      (0, _isomorphicFetch2.default)("http://localhost:3000/update", {
        method: 'POST',
        body: formData
      }).then(function (res) {
        if (res.status >= 400) {
          _this5.alertMessage(res.status);
        } else {
          return res.json();
        }
      }).then(function (json) {
    ...
    value: function uploadImage(e) {
      ...
      parse(e).then(function (obj) {
        console.log(obj);
        var blob = obj.blob,
            type = obj.type;

        var tmp_image_path = URL.createObjectURL(new Blob([blob], { type: type }));
        _this6.setState({ blob: new Blob([blob], { type: type }), tmp_image_path: tmp_image_path });
      }).catch(function (e) {
        _this6.alertMessage("画像をロードできませんでした");
      });
    }
  }, {
    key: 'renderLeftNode',
    value: function renderLeftNode(msg) {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'section',
          { className: 'node' },
          _react2.default.createElement('img', { src: "./cat.jpg", className: 'photo_l' }),
          _react2.default.createElement(
            'div',
            { className: 'info_l' },
            _react2.default.createElement(
    ...
    key: 'renderRightNode',
    value: function renderRightNode(msg) {
      return _react2.default.createElement(
        'div',
        { key: msg._id },
        _react2.default.createElement(
          'section',
          { className: 'node' },
          _react2.default.createElement('img', { src: "./cat.jpg", className: 'photo_r' }),
          _react2.default.createElement(
            'div',
            { className: 'info_r' },
            _react2.default.createElement(
    ...
    value: function render() {
      ...
      var _state2 = this.state,
          tmp_image_path = _state2.tmp_image_path,
          message = _state2.message,
          msgs = _state2.msgs,
          user_id = _state2.user_id;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          msgs.map(function (msg) {
            return _this7.renderRightNode(msg);
        ...
        _react2.default.createElement(
          ...
          tmp_image_path ? _react2.default.createElement('img', { src: tmp_image_path, width: '36', height: '36' }) : "",
          _react2.default.createElement('input', { type: 'file', name: 'image', id: 'image', onChange: function onChange(e) {
              return _this7.uploadImage(e);
            } }),
          _react2.default.createElement('input', { type: 'text', value: message, id: 'text-area', onChange: function onChange(e) {
              return _this7.setState({ message: e.target.value });
            } }),
          _react2.default.createElement(
            'button',
            { onClick: function onClick(e) {
                return _this7.sendMessage(e);
              }, id: 'submit-button' },
            "Send"
          )
        )
...
_reactDom2.default.render(_react2.default.createElement(Message, null), document.getElementById("app"));
